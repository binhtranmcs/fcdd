...
from fcdd.runners.argparse_configs import DefaultBTADConfig


class SingleBTADConfig(DefaultBTADConfig):
...
if __name__ == '__main__':
    runner = SeedsRunner(SingleBTADConfig())
    runner.args.logdir += '_btad_single_run_cls{}_'.format(runner.args.normal_class)
    runner.run()
    print()
